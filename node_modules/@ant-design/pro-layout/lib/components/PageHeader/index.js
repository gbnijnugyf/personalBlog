...
var renderBreadcrumb = function renderBreadcrumb(breadcrumb, prefixCls) {
  ...
  return (0, _jsxRuntime.jsx)(_antd.Breadcrumb, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, breadcrumb), {}, {
...
var getBackIcon = function getBackIcon(props) {
  ...
  return direction === 'rtl' ? (0, _jsxRuntime.jsx)(_ArrowRightOutlined.default, {}) : (0, _jsxRuntime.jsx)(_ArrowLeftOutlined.default, {});
};
var renderTitle = function renderTitle(prefixCls, props) {
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    ...
    children: [hasTitle && (0, _jsxRuntime.jsxs)("div", {
      className: "".concat(headingPrefixCls, "-left ").concat(hashId),
      children: [backIconDom, avatar && (0, _jsxRuntime.jsx)(_antd.Avatar, (0, _objectSpread2.default)({
        className: (0, _classnames.default)("".concat(headingPrefixCls, "-avatar"), hashId, avatar.className)
      }, avatar)), title && (0, _jsxRuntime.jsx)("span", {
        ...
        children: subTitle
      }), tags && (0, _jsxRuntime.jsx)("span", {
        className: "".concat(headingPrefixCls, "-tags ").concat(hashId),
        children: tags
      })]
    }), extra && (0, _jsxRuntime.jsx)("span", {
...
var PageHeader = function PageHeader(props) {
  ...
  return wrapSSR((0, _jsxRuntime.jsx)(_rcResizeObserver.default, {
    onResize: onResize,
