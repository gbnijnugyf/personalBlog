...
var FooterToolbar = function FooterToolbar(props) {
  ...
  var ssrDom = !(0, _proUtils.isBrowser)() ? renderDom : /*#__PURE__*/(0, _reactDom.createPortal)(renderDom, containerDom, baseClassName);
  return stylish.wrapSSR(wrapSSR((0, _jsxRuntime.jsx)(_react.default.Fragment, {
    children: ssrDom
  }, baseClassName)));
};
